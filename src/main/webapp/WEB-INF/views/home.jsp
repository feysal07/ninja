        ...
        <div class="col-md-9">
            ...
            <div class="carousel slide carousel-v1 margin-bottom-40" id="myCarousel-1">
                <div class="carousel-inner">
                    <div class="item active">
                        <img alt="" src="resources/assets/img/posts/2.jpg">
                        <div class="carousel-caption">
                            <p>Facilisis odio, dapibus ac justo acilisis gestinas.</p>
                        </div>
                    </div>
                    <div class="item">
                        <img alt="" src="resources/assets/img/posts/1.jpg">
                        <div class="carousel-caption">
                            <p>Cras justo odio, dapibus ac facilisis into egestas.</p>
                        </div>
                        </div>
                    <div class="item">
                        <img alt="" src="resources/assets/img/posts/3.jpg">
                        <div class="carousel-caption">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="magazine-news-img">
                            <a href="#"><img class="img-responsive" src="resources/assets/img/main/9.jpg" alt=""></a>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="magazine-news-img">
                            <a href="#"><img class="img-responsive" src="resources/assets/img/main/10.jpg" alt=""></a>
                        </div>
                        <h3><a href="#">Simelque Untine Culpaqui Officia Deserunt Blanditiis Praesentium</a></h3>
                        <div class="by-author">
                ...
                <div class="col-md-8">
                    <div class="search-blocks search-blocks-top-sea">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <h2><a href="#">Sea Bordered Box</a></h2>
                    ...
                    <div class="search-blocks search-blocks-top-yellow">
                        <div class="row">
                            <div class="col-md-4 search-img">
                                <img alt="" src="resources/assets/img/new/img1.jpg" class="img-responsive">
                                <ul class="list-unstyled">
                                   <li><i class="icon-briefcase"></i> Dell, Google</li>
                                   <li><i class="icon-map-marker"></i> New York, US</li>
                                </ul>
                            ...
                            <div class="col-md-8">
                                <h2><a href="#">Yellow Bordered Box</a></h2>
                                <ul class="list-unstyled search-rating">
                                   <li><i class="icon-star"></i></li>
                                   <li><i class="icon-star"></i></li>
                                   <li><i class="icon-star"></i></li>
            ...
            <div class="magazine-news">
                <div class="row">
                    <div class="col-md-4">
                        <div class="magazine-news-img">
                            <a href="#"><img class="img-responsive" src="resources/assets/img/main/1.jpg" alt=""></a>
                        </div>
                        <h3><a href="#">Simelque Untine Culpaqui Officia Deserunt</a></h3>
                        <div class="by-author">
                            <strong>by Jack Villo</strong>
                            <span>/ September 19, 2013</span>
                        </div> 
                    ...
                    <div class="col-md-4">
                        <div class="magazine-news-img">
                            <a href="#"><img class="img-responsive" src="resources/assets/img/main/2.jpg" alt=""></a>
                        </div>
                        <h3><a href="#">Simelque Untine Culpaqui Officia Deserunt</a></h3>
                        <div class="by-author">
                            <strong>by Ann Diwver</strong>
                            <span>/ September 19, 2013</span>
                        </div> 
                        <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate...</p>
                    </div>
                    <div class="col-md-4">
                        <div class="magazine-news-img">
                            <a href="#"><img class="img-responsive" src="resources/assets/img/main/3.jpg" alt=""></a>
                        </div>
                        <h3><a href="#">Simelque Untine Culpaqui Officia Deserunt</a></h3>
                        <div class="by-author">
                            <strong>by Admin</strong>
